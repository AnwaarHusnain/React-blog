  ...
  return (
    <div className="py-10 grid grid-cols-1 gap-10">
      <div className="flex flex-col gap-5 items-center justify-center text-center px-3">
        ...
        <h3 className="font-primaryfont text-2xl 2xl:text-5xl">Articles and Blogs</h3>
      ...
      <div className="grid grid-cols-1 place-items-center text-center md:grid-cols-2 lg:grid-cols-3 ">
        <BlogCard
          img={blog1}
